...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereVacanteId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereCv($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Candidato query()
     ...
     */
    class Candidato extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Vacante> $vacante
     * @property-read int|null $vacante_count
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Vacante> $vacantes
     * @property-read int|null $vacantes_count
     * @method static \Illuminate\Database\Eloquent\Builder|Salario whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Salario whereSalario($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Salario whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Salario whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Salario newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Salario newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|Salario query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Salario extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon $ultimo_dia
     * @property string $empresa
     * @property int $categoria_id
     * @property int $salario_id
     * @property string $titulo
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $id
     * @property-read \App\Models\Salario $salario
     * @property-read \App\Models\Categoria $categoria
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Candidato> $candidatos
     * @property-read int|null $candidatos_count
     * @property-read \App\Models\User $reclutador
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereTitulo($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereSalarioId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereCategoriaId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereEmpresa($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereUltimoDia($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereDescripcion($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereImagen($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante wherePublicado($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Vacante whereUserId($value)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Vacante extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
